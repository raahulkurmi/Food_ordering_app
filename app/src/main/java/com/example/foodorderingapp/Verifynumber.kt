...
import com.example.foodorderingapp.databinding.ActivityVerifynumberBinding
...
class Verifynumber : AppCompatActivity() {
    private val binding by lazy {
        ActivityVerifynumberBinding.inflate(layoutInflater)
    }
    ...
    Firebase.auth.signInWithCredential(credential)
        .addOnCompleteListener(this) { task ->
            if (task.isSuccessful) {
                ...
                startActivity(Intent(this@Verifynumber,Locationactivity::class.java))
            } else {
                // Verification failed
...
private val callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
    ...
    override fun onCodeSent(
        ...
        this@Verifynumber.verificationId = verificationId
        resendToken = token
        Toast.makeText(this@Verifynumber, "OTP has been resent", Toast.LENGTH_SHORT).show()
    }
}
