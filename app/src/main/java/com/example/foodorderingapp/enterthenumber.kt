...
import com.example.foodorderingapp.databinding.ActivityEnterthenumberBinding
...
class enterthenumber : AppCompatActivity() {
    private val binding by lazy {
        ActivityEnterthenumberBinding.inflate(layoutInflater)
    }
    ...
    val callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        override fun onCodeSent(
            ...
            val intent= Intent(this@enterthenumber,Verifynumber::class.java)
            intent.putExtra("otp",verificationId)
            intent.putExtra("resendtoken",token)
            intent.putExtra("mobile",number1)
            Toast.makeText(this@enterthenumber, "Otp sent", Toast.LENGTH_SHORT).show()
